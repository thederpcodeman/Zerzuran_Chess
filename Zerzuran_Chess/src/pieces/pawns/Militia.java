    ...
    public ImageIcon getImageIcon() {
        if(color == 0) {
            if (getForwardDirection() == 1){
                return(new ImageIcon("Zerzuran_Chess/src/resources/bMilitia.png"));
            }else{
                return(new ImageIcon("Zerzuran_Chess/src/resources/bupMilitia.png"));
            }

        } else if(color == 1) {
            if (getForwardDirection() == -1){
                return(new ImageIcon("Zerzuran_Chess/src/resources/wMilitia.png"));
            }else{
                return(new ImageIcon("Zerzuran_Chess/src/resources/wupMilitia.png"));
            }
        } else {
            return null;
        }
